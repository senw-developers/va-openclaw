...
const loadDmPairingHandlers = lazyHandlerModule(
  () => import("./server-methods/dm-pairing.js"),
  (module) => module.dmPairingHandlers,
);
...
export const coreGatewayHandlers: GatewayRequestHandlers = {
  ...
  ...createLazyCoreHandlers({
    methods: ["dm.pair.list", "dm.pair.approve", "dm.pair.reject"],
    loadHandlers: loadDmPairingHandlers,
  }),
  ...createLazyCoreHandlers({
